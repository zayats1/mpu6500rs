    ...
    I2C: i2c::I2c,
{
    ...
    where
        DELAY: delay::DelayNs,
    {
        let dev_id = Self::who_am_i(addr, i2c).map_err(|e| Mpu6500Err::I2cErr(e))?;
    ...
    fn gyro_cfg(
        ...
        let mut c = [0; 1];
        Self::read_register(addr, i2c, Register::GYRO_CFG, &mut c)?;
    ...
    fn accel_cfg(
        ...
        let mut c = [0; 1];
        Self::read_register(addr, i2c, Register::ACCEL_CFG_2, &mut c)?;
    ...
    fn fifo_count_h(addr: u8, i2c: &mut I2C) -> Result<u16, <I2C as embedded_hal::i2c::ErrorType>::Error> {
        let mut buf = [0; 2];
    ...
    fn fifo_read(addr: u8, i2c: &mut I2C) -> Result<(Vector3<i16>, Vector3<i16>), <I2C as embedded_hal::i2c::ErrorType>::Error> {
        let mut buf = [0; 12];
    ...
    fn who_am_i(addr: u8, i2c: &mut I2C) -> Result<u8, <I2C as embedded_hal::i2c::ErrorType>::Error> {
        let mut buf = [0; 1];
    ...
    fn read_accel_offset(addr: u8, i2c: &mut I2C) -> Result<Vector3<i16>, <I2C as embedded_hal::i2c::ErrorType>::Error> {
        let mut buf = [0; 2];
    ...
    fn write_register(addr: u8, i2c: &mut I2C, reg: Register, cmd: u8) -> core::result::Result<(), <I2C as embedded_hal::i2c::ErrorType>::Error> {
